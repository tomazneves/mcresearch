...
public interface Container extends Clearable {
   ...
   static boolean stillValidBlockEntity(BlockEntity pBlockEntity, Player pPlayer) {
      return stillValidBlockEntity(pBlockEntity, pPlayer, pPlayer.getAttributeValue(net.minecraftforge.common.ForgeMod.BLOCK_REACH.get()) + 3.5); // Vanilla uses 8, default reach is 4.5 so add 3.5 padding
   }

   static boolean stillValidBlockEntity(BlockEntity pBlockEntity, Player pPlayer, int pMaxDistance) {
       return stillValidBlockEntity(pBlockEntity, pPlayer, (double)pMaxDistance);
   }

   static boolean stillValidBlockEntity(BlockEntity pBlockEntity, Player pPlayer, double pMaxDistance) {
