...
public class HorseInventoryMenu extends AbstractContainerMenu {
   ...
   public boolean stillValid(Player pPlayer) {
      ...
      double reach = pPlayer.getAttributeValue(net.minecraftforge.common.ForgeMod.ENTITY_REACH.get()) + 5;
      return !this.horse.hasInventoryChanged(this.horseContainer) && this.horseContainer.stillValid(pPlayer) && this.horse.isAlive() && this.horse.distanceTo(pPlayer) < reach;
   }
